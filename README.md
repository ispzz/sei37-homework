...
- **Clone your forked repository to your computer**
  ...
  - Make sure your browser is open to your forked version of this repository on Github (eg http://github.com/{{YOUR_USERNAME}}/sei37-homework)
...
- **Add an upstream remote repository**
 ...
 - ```cd sei37-homework```
 - ```git remote add upstream https://github.com/ispzz/sei37-homework```
...
2. Go to your local homework repo (eg, cd ~/sei/homework): ```cd sei37-homework```
...
- ##### Once you're finished, submit a pull request for me to accept your homework
  - Navigate to your forked version of this repository on Github (eg https://github.com/{{YOUR_USERNAME_HERE}}/sei37-homework).
