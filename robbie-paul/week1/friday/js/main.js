...
// multi LINE TRIP PROGRAM

// 1. Look for start station in array/ . Eg. Times Square
// look through line array for whichever input is

// 2. Count stations from 'Times Square' to Union square
    // get index of times sq; then get index of union square, 
    // subtract index of times square from union square
    // Use sliceOf to copy the items into new array and print them to the console.

// 3. look for destination stn in other arrays
        // keep looking until found destination station

// 4. count stations from union square\ to destination point / 33rd 
...
// 5. 
  ...
  const singleLineTrip = function(line, startStation, endStation) {
    let startStationIndex = line.indexOf(startStation)

    // let station = MTA[key][i].;
    // console.log(startStation)
...
// const multiLineTrip = function() {

// } 


// .indexOf(), .slice(), .reverse()
